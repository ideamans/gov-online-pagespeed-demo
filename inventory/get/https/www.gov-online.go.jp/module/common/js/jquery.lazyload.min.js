...
!(function ($, window, document, undefined) {
  ...
  ($.fn.lazyload = function (options) {
    ...
    return (
      options &&
        (void 0 !== options.failurelimit &&
          ((options.failure_limit = options.failurelimit), delete options.failurelimit),
        void 0 !== options.effectspeed && ((options.effect_speed = options.effectspeed), delete options.effectspeed),
        $.extend(settings, options)),
      ($container = void 0 === settings.container || settings.container === window ? $window : $(settings.container)),
      ...
      this.each(function () {
        var self = this,
          $self = $(self);
        (self.loaded = !1),
          (void 0 !== $self.attr("src") && !1 !== $self.attr("src")) ||
            ($self.is("img") && $self.attr("src", settings.placeholder)),
    ...
    ($.belowthefold = function (element, settings) {
      ...
      return (
        (fold =
          void 0 === settings.container || settings.container === window
        ...
        $(element).offset().top - settings.threshold
      );
    }),
    ($.rightoffold = function (element, settings) {
      ...
      return (
        ...
        $(element).offset().left - settings.threshold
      );
    }),
