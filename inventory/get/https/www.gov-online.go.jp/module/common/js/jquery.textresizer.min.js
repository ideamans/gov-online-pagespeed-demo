...
*/ (function (e) {
  ...
  (r = function (e) {
    ...
    (t.defaults = { debugMode: !1, type: "fontSize", target: "body", selectedIndex: -1, suppressClickThrough: !0 }),
    ...
    (t.prototype.deserializeHash = function (e) {
      var t,
        ...
        s = /\&|\|/g,
        o = e.split(s);
      for (t = 0, n = o.length; t < n; t += 1) (r = o[t].split("=")), (i[r[0]] = window.decodeURIComponent(r[1]));
      return i;
    }),
    ...
    (t.prototype.setCookie = function (t, r, i, s) {
      ...
      "object" == typeof s
        ...
        : (e.cookie(o, s, u), this.settings.debugMode && n("In setCookie: Cookie (not hash): " + o + ": " + s));
    }),
    ...
    (t.prototype.loadPreviousState = function () {
      ...
      e.cookie
        ? (t.debugMode && n("In loadPreviousState(): jquery.cookie: INSTALLED"),
          ...
          t.debugMode &&
            (n("In loadPreviousState: selectedIndex: " + i + "; type: " + typeof i),
            n("In loadPreviousState: prevSize: " + s + "; type: " + typeof s)),
          s && this.applyFontSize(s))
        : t.debugMode && n("In loadPreviousState(): jquery.cookie: NOT INSTALLED");
    }),
    ...
    (t.prototype.init = function () {
      ...
      (this.settings = e.extend(
        { selector: this.$elements.selector, sizes: this.buildDefaultFontSizes(r) },
